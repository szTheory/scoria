...
Read this with the [README](README.md), the [capability ladder](guides/jtbd-and-user-flows.md), [Reviewer Verification](guides/reviewer-verification.md), [Ownership Boundary](guides/ownership-boundary.md), and the [Glossary](guides/reference/glossary.md). The executable comparison guide contract is `Scoria.AdopterDocContract.comparison_guide_path/0` in `lib/scoria/adopter_doc_contract.ex`.
