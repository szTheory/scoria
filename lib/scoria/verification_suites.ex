defmodule Scoria.VerificationSuites do
  ...
  @suites [
    ...
    %{
      id: :adoption,
      name: "Default runtime verification suite",
    ...
    %{
      ...
      name: "Runtime-to-handoff verification suite",
    ...
    %{
      ...
      name: "Semantic fast-path verification suite",
      command:
    ...
    %{
      id: :knowledge,
      name: "Optional knowledge base verification suite",
    ...
    %{
      id: :connector,
      name: "Remote connector verification suite",
    ...
    %{
      ...
      name: "Support copilot gallery verification suite",
  ...
  @suite_by_id Map.new(@suites, &{&1.id, &1})
  @closeout_order [:release_preview, :adoption, :runtime_to_handoff]

  def all, do: @suites

  def ids, do: Enum.map(@suites, & &1.id)

  def fetch!(id), do: Map.fetch!(@suite_by_id, id)
  ...
  def boundary_sentence(id) do
    case exclusions(id) do
      ...
      exclusions ->
        "This verification suite does not require #{format_exclusions(exclusions)}."
    end
  end
