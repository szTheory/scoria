...
- ✅ **v3.4 Pre-1.0 Trust & Security Hardening** — Phases 42–45, fixed 3 P0 bugs (eval fail-open, knowledge cross-tenant leak, dashboard auth bypass) + correctness sweep (completed 2026-07-09; archive pending)

## Phases

### v3.4 Pre-1.0 Trust & Security Hardening — completed, awaiting archive

SEED-006. Fix + prove only; no Hex publish (that release cut belongs to SEED-005 / 999.2). Phases 42/43/44 completed independent subsystem work (eval / knowledge / web); Phase 45 closed the shared correctness and doctrine proof.
...
- [x] **Phase 45: Correctness sweep + fail-closed proof & closeout** - Real cosine `score_chunk`, label-aware citation scoring, dead chunker param removed, real latency gate, and scope-doctrine cross-link (completed 2026-07-07)
...
- [x] 45-01-PLAN.md — Pgvector cosine score repair and persisted retrieval proof
- [x] 45-02-PLAN.md — Citation answerability labels and default chunker non-overlap cleanup
- [x] 45-03-PLAN.md — Shared latency timing helper plus offline/judge fail-closed latency proof

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 45-04-PLAN.md — Online scoring latency measurement and duration proof

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 45-05-PLAN.md — Scope doctrine cross-links and Phase 45 closeout verification
...
| 45. Correctness sweep + fail-closed proof      | v3.4      | 5/5            | Complete    | 2026-07-07 |
