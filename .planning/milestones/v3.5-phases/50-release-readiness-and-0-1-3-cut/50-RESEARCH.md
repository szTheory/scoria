...
> Both questions are advisory/discretionary, not decision-blocking. Q1 is procedurally addressed by plan 50-02's requirement to run the seed end-to-end and confirm all block (g) success lines print; Q2 is Claude's-Discretion content-depth guidance carried into plan 50-01's restoration scope (restore at minimum the asserted literals; richer sections optional).
