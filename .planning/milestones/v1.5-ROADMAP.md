...
- ✅ **v1.5 Switchyard** — Phases 19-22 (shipped 2026-05-18; details: `.planning/milestones/v1.5-ROADMAP.md`)
- 🚧 **v1.6 Flightpath** — Phases TBD (active)

## Current Milestone

**v1.6 Flightpath**

- Theme: Prompt lifecycle and eval-release operations
- Goal: TBD
- Requirements: TBD
- Status: Ready to begin milestone planning
