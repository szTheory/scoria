...
- [x] 43-03-PLAN.md — Public Knowledge API write/list/run/result enforcement
...
- [x] 43-05-PLAN.md — Citation/grounding scope, docs, and full knowledge proof
...
- [ ] 44-01-PLAN.md — Router `on_mount:` pass-through plus `ScoriaWeb.DashboardScope` resolver/gate
...
| 44. Dashboard auth seam                        | v3.4      | 0/7            | Not started | -         |
