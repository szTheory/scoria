...
**Plans**: 6 plans
  ...
  - [x] 16-06-PLAN.md — Targeted Playwright parity smoke + optional contrast guard (MOTION-01..04)
**UI hint**: yes
...
**Plans**: 3 plans
  ...
  - [x] 17-02-PLAN.md — Contact-sheet generator + .gitignore + contact_sheet_index.md + MAINTAINERS command (PROOF-02)
