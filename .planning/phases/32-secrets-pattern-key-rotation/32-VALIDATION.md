...
| 32-01-03 | 01 | 1 | SEC-02 | T-32-05 | Rotation is recorded as redacted maintainer attestation only; no secret value, prefix, suffix, screenshot, or token material is stored. | human checkpoint + static artifact check | `grep -q 'SEC-02:' .planning/phases/32-secrets-pattern-key-rotation/32-SUMMARY.md && grep -q 'Maintainer attested' .planning/phases/32-secrets-pattern-key-rotation/32-SUMMARY.md && ! grep -nE 'sk-ant-[A-Za-z0-9_-]+' .planning/phases/32-secrets-pattern-key-rotation/32-SUMMARY.md .planning/phases/32-secrets-pattern-key-rotation/32-VERIFICATION.md` | post-execution | pending |
