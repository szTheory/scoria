...
- [x] **REL-04**: The `0.1.3` release PR reaches green `ci-gate`, publishes to Hex, and passes post-publish smoke for fresh install plus live-lineage upgrade.
