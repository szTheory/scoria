...
- [x] **RETR-01**: A `RETRIEVER` span is emitted at the single `Knowledge.retrieve/2` call site, dual-written alongside `ai_retrieval_runs` (kept as system-of-record — not collapsed), reusing the trace_id/span_id/latency it already computes.
